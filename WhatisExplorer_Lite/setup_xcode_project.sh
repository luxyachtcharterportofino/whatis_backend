#!/bin/bash
# Script completo per setup progetto Xcode WhatisExplorerLite

set -e

PROJECT_NAME="WhatisExplorerLite"
BUNDLE_ID="com.andaly.WhatisExplorerLite"
PROJECT_DIR="$HOME/Desktop/WhatisExplorer_Lite"
SOURCE_DIR="$PROJECT_DIR/WhatisExplorerLite"
...
echo "   a) Elimina il file WhatisExplorerLiteApp.swift generato"
echo "   b) Trascina la cartella WhatisExplorerLite/ nel progetto"
echo "   c) Assicurati che 'Copy items if needed' sia selezionato"
echo "   d) Seleziona 'Create groups'"
echo "   e) Seleziona il target WhatisExplorerLite"
echo ""
echo "7. Configura Info.plist:"
echo "   - Aggiungi Info.plist dalla cartella WhatisExplorerLite/"
